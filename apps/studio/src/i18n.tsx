...
const es = {
  ...
  "process.connect.text": "Transmití aceleración, giro y orientación de las IMUs Arduino mediante USB serie.",
...
const en: Record<TranslationKey, string> = {
  ...
  "process.connect.text": "Stream acceleration, rotation and orientation from Arduino IMUs over USB serial.",
