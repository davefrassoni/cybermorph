...
const es = {
  ...
  "hero.build": "v0.2 preview · Windows 10/11 · actualizaciones automáticas",
  ...
  "serial.unsupported": "Usá Chrome o Edge para conectar por USB",
  ...
  "firmware.eyebrow": "USB / PROGRAMADOR",
  "firmware.title": "Instalar firmware en Arduino",
  "firmware.description": "Conectá una placa por USB. El archivo se transmite directamente desde este dispositivo: no se sube a ningún servidor.",
  "firmware.close": "Cerrar",
  "firmware.unsupported": "Este navegador no ofrece Web Serial. Abrí CyberMorph en Chrome, Edge o en la aplicación de escritorio.",
  "firmware.board": "Placa y bootloader",
  "firmware.board.uno": "Arduino Uno · ATmega328P",
  "firmware.board.nano": "Arduino Nano · bootloader nuevo",
  "firmware.board.nano-old": "Arduino Nano · bootloader anterior",
  "firmware.installBase": "Instalar firmware base CyberMorph",
  "firmware.chooseHex": "Elegir archivo .hex",
  "firmware.installCustom": "Instalar .hex seleccionado",
  "firmware.flashing": "Programando — no desconectar",
  "firmware.success": "Firmware instalado. La placa se reinició correctamente.",
  "firmware.error": "No se pudo instalar el firmware.",
  "firmware.scopeTitle": "Compatibilidad actual",
  "firmware.scope": "Flasheo directo para Uno y Nano con ATmega328P mediante STK500v1. El firmware base transmite el protocolo CyberMorph y sirve para validar la conexión; adaptá readJoint() a tus IMUs para obtener movimiento real.",
  "firmware.otherBoards": "Abrir Arduino Cloud para otras placas",
  "update.idle": "Buscar actualización",
  "update.checking": "Buscando…",
  "update.available": "Actualización encontrada",
  "update.downloading": "Descargando {{percent}}%",
  "update.ready": "Reiniciar y actualizar",
  "update.current": "Software actualizado",
  "update.error": "Reintentar actualización",
  "avatar.eyebrow": "GEMELO DIGITAL",
  "avatar.reset": "Restablecer pose",
  "avatar.limits": "Rango anatómico seguro",
...
const en: Record<TranslationKey, string> = {
  ...
  "hero.build": "v0.2 preview · Windows 10/11 · automatic updates",
  ...
  "serial.unsupported": "Use Chrome or Edge to connect over USB",
  ...
  "firmware.open": "Firmware",
  "firmware.eyebrow": "USB / PROGRAMMER",
  "firmware.title": "Install firmware on Arduino",
  "firmware.description": "Connect a board over USB. The file is transferred directly from this device and is never uploaded to a server.",
  "firmware.close": "Close",
  "firmware.unsupported": "This browser does not provide Web Serial. Open CyberMorph in Chrome, Edge or the desktop application.",
  "firmware.board": "Board and bootloader",
  "firmware.board.uno": "Arduino Uno · ATmega328P",
  "firmware.board.nano": "Arduino Nano · new bootloader",
  "firmware.board.nano-old": "Arduino Nano · old bootloader",
  "firmware.installBase": "Install CyberMorph base firmware",
  "firmware.chooseHex": "Choose .hex file",
  "firmware.installCustom": "Install selected .hex",
  "firmware.flashing": "Flashing — do not disconnect",
  "firmware.success": "Firmware installed. The board restarted successfully.",
  "firmware.error": "The firmware could not be installed.",
  "firmware.scopeTitle": "Current compatibility",
  "firmware.scope": "Direct flashing for Uno and Nano boards with ATmega328P over STK500v1. The base firmware streams the CyberMorph protocol to validate the connection; adapt readJoint() to your IMUs for real motion.",
  "firmware.otherBoards": "Open Arduino Cloud for other boards",
  "update.idle": "Check for update",
  "update.checking": "Checking…",
  "update.available": "Update found",
  "update.downloading": "Downloading {{percent}}%",
  "update.ready": "Restart and update",
  "update.current": "Software is current",
  "update.error": "Retry update",
  "avatar.eyebrow": "DIGITAL TWIN",
  "avatar.reset": "Reset pose",
  "avatar.limits": "Safe anatomical range",
  "pose.neutral": "neutral",
  "pose.reach": "reach",
  "pose.twist": "twist",
  "pose.crouch": "crouch",
